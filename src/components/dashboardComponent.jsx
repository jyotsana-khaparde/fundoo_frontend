              ...
              <div id="appBarMenuAndTitle">
                <div id="appBarMenuAndTitle1">
                  ...
                  >
                    <div id="keepImage">
                      <img
                        src={require("/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/keep.png")}
                        alt="keep icon"
                      />
                    </div>
                  ...
                  <div style={{ marginLeft: "15px" }}>
                    <IconButton onClick={this.handleRefresh}>
                      <Tooltip title="Refresh">
                        <img
                          src={require("/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/refresh.svg")}
                          alt="refresh icon"
                        />
                      </Tooltip>
                    </IconButton>
                  ...
                  <div>
                    <IconButton>
                      <Tooltip title="Grid View">
                        <img
                          src={require("/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/listView.svg")}
                          alt="refresh icon"
                        />
                      </Tooltip>
                    </IconButton>
                  ...
                  <div>
                    <IconButton>
                      <Tooltip title="Settings">
                        <img
                          src={require("/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/setting.svg")}
                          alt="refresh icon"
                        />
                      </Tooltip>
                    </IconButton>
                  ...
                  <div style={{ paddingLeft: "120px", display: "flex" }}>
                    <div>
                      <IconButton>
                        <Tooltip title="Google apps">
                          <img
                            src={require("/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/baseline-apps-24px.svg")}
                            alt="refresh icon"
                          />
                        </Tooltip>
                      </IconButton>
                    ...
                    <div>
                      <IconButton>
                        ...
                        >
                          <img
                            src={require("/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/notify.jpg")}
                            alt="refresh icon"
                          />
                        </Tooltip>
                      </IconButton>
                    ...
                    <div>
                      {/* <IconButton onClick={this.handleSignout()}>
                                            <Tooltip title="Account" style={{ height: "26px", width: "26px" }}>
                                                <img src={require('/home/bridgeit/Jyotsana/fundooNotes/frontend/src/assets/images/account.png')} alt="refresh icon" />
                                            </Tooltip>
                                        </IconButton> */}
